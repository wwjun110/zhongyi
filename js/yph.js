...
var $dom={
		...
		c : function (){
			...
			this.popup.innerHTML='<img src="'+yP_imgServer+'/images/close.gif" style="position:absolute;top:2px;right:2px;cursor:pointer;width;10px;height:10px;z-index:110000" onclick="$dom.hi()">'+yP_htmlcode+'';
			s.display="none";
